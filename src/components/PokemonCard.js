...
export const PokemonCard = (props) => {
  ...
  return (
    <>
      <div className={ isHome ? 'col-md-6 col-sm-12 col-lg-4 col-xs-12' : 'col-12' } onClick={() => history.push('/detail/' + props.pokemon.name)}>
        <div className={ isHome ? 'card p-3 mb-3 cardShadow pointer' : 'card p-3 mb-3 cardShadow' } >
          {isHome && (
